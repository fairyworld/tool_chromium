...
#ifndef CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_FUNCTIONS_H_
#define CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_FUNCTIONS_H_
...
// |options| may be null.
//
// If the |MOJO_LEGACY_INITIALIZE_FLAG_LOAD_ONLY| flag is given in |options|,
// this only partially initializes the library. Other Mojo APIs will remain
// unavailable until the library is fully initialized by a subsequent call to
// |MojoInitialize()| WITHOUT the flag. See documentation on
// |MOJO_LEGACY_INITIALIZE_FLAG_LOAD_ONLY| in types.h for details.
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| if Mojo initialization was successful.
//   |MOJO_LEGACY_RESULT_NOT_FOUND| if the Mojo Core library could not be loaded
//   or
//       appears to be malformed.
//   |MOJO_LEGACY_RESULT_FAILED_PRECONDITION| if the Mojo Core library AND full
//   IPC
//       support has already been initialized by some prior call(s) to
//       |MojoInitialize()|.
//   |MOJO_LEGACY_RESULT_ALREADY_EXISTS| if
//   |MOJO_LEGACY_INITIALIZE_FLAG_LOAD_ONLY| was
...
//   |MOJO_LEGACY_RESULT_INVALID_ARGUMENT| if |options| was non-null and
//   invalid.
...
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| if shutdown was successful.
//   |MOJO_LEGACY_RESULT_INVALID_ARGUMENT| if |options| was non-null and
//   invalid. |MOJO_LEGACY_RESULT_FAILED_PRECONDITION| if |MojoInitialize()| was
//   never called. |MOJO_LEGACY_RESULT_UNIMPLEMENTED| if the caller is a Mojo
//   Core embedder and is
...
MOJO_LEGACY_SYSTEM_EXPORT MojoTimeTicks MojoGetTimeTicksNow(void);
...
// |MOJO_LEGACY_RESULT_CANCELLED| if they properly overlap (this is likely the
// case with traps), or fail with |MOJO_LEGACY_RESULT_INVALID_ARGUMENT| if they
// happen after.
MOJO_LEGACY_SYSTEM_EXPORT MojoResult MojoClose(MojoHandle handle);
...
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| on success. |*signals_state| is populated with the
//       last known signals state of |handle|.
//   |MOJO_LEGACY_RESULT_INVALID_ARGUMENT| if |handle| is not a valid handle or
...
#endif  // CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_FUNCTIONS_H_

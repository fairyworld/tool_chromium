...
#ifndef CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_TRAP_H_
#define CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_TRAP_H_
...
#ifdef __cplusplus
inline constexpr MojoTrapEventFlags MOJO_LEGACY_TRAP_EVENT_FLAG_NONE = 0;
inline constexpr MojoTrapEventFlags
    MOJO_LEGACY_TRAP_EVENT_FLAG_WITHIN_API_CALL = 1 << 0;
#else
#define MOJO_LEGACY_TRAP_EVENT_FLAG_NONE ((MojoTrapEventFlags)0)
#define MOJO_LEGACY_TRAP_EVENT_FLAG_WITHIN_API_CALL ((MojoTrapEventFlags)1 << 0)
#endif

// Structure passed to trap event handlers when invoked by a tripped trap.
struct MOJO_LEGACY_ALIGNAS(8) MojoTrapEvent {
  // The size of this structure, used for versioning.
  uint32_t struct_size;

  // May take on some combination of the following values:
  //
  //   |MOJO_LEGACY_TRAP_EVENT_FLAG_NONE|: No flags.
  //
  //   |MOJO_LEGACY_TRAP_EVENT_FLAG_WITHIN_API_CALL|: The trap was tripped
  //   within the
  ...
  MOJO_LEGACY_POINTER_FIELD(uintptr_t, trigger_context);

  // A result code indicating the cause of the event. May take on any of the
  // following values:
  //
  //   |MOJO_LEGACY_RESULT_OK|: The trigger's conditions were met.
  //   |MOJO_LEGACY_RESULT_FAILED_PRECONDITION|: The trigger's observed handle
  //   has
  //       changed state in such a way that the trigger's conditions can never
  //       be met again.
  //   |MOJO_LEGACY_RESULT_CANCELLED|: The trigger has been removed and will
  //   never
  ...
  //
  //       Unlike the other result types above |MOJO_LEGACY_RESULT_CANCELLED|
  //       can fire even when the trap is disarmed.
  MojoResult result;
...
MOJO_LEGACY_STATIC_ASSERT(sizeof(struct MojoTrapEvent) == 32,
...
//
//   |MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_UNSATISFIED| - A trigger added with
//   this
//       condition will trip its trap when any of its observed signals
//       transition from being satisfied to being unsatisfied.
//   |MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_SATISFIED| - A triger added with
//   this
//       condition will trip its trap  when any of its observed signals
...
inline constexpr MojoTriggerCondition
    MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_UNSATISFIED = 0;
inline constexpr MojoTriggerCondition
    MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_SATISFIED = 1;
#else
#define MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_UNSATISFIED \
  ((MojoTriggerCondition)0)
#define MOJO_LEGACY_TRIGGER_CONDITION_SIGNALS_SATISFIED \
...
#ifdef __cplusplus
inline constexpr MojoCreateTrapFlags MOJO_LEGACY_CREATE_TRAP_FLAG_NONE = 0;
#else
#define MOJO_LEGACY_CREATE_TRAP_FLAG_NONE ((MojoCreateTrapFlags)0)
#endif

// Options passed to |MojoCreateTrap()|.
struct MOJO_LEGACY_ALIGNAS(8) MojoCreateTrapOptions {
  // The size of this structure, used for versioning.
  uint32_t struct_size;
...
MOJO_LEGACY_STATIC_ASSERT(sizeof(struct MojoCreateTrapOptions) == 8,
...
#ifdef __cplusplus
inline constexpr MojoAddTriggerFlags MOJO_LEGACY_ADD_TRIGGER_FLAG_NONE = 0;
#else
#define MOJO_LEGACY_ADD_TRIGGER_FLAG_NONE ((MojoAddTriggerFlags)0)
#endif

// Options passed to |MojoAddTrigger()|.
struct MOJO_LEGACY_ALIGNAS(8) MojoAddTriggerOptions {
  // The size of this structure, used for versioning.
  uint32_t struct_size;
...
MOJO_LEGACY_STATIC_ASSERT(sizeof(struct MojoAddTriggerOptions) == 8,
...
#ifdef __cplusplus
inline constexpr MojoRemoveTriggerFlags MOJO_LEGACY_REMOVE_TRIGGER_FLAG_NONE =
    0;
#else
#define MOJO_LEGACY_REMOVE_TRIGGER_FLAG_NONE ((MojoRemoveTriggerFlags)0)
#endif

// Options passed to |MojoRemoveTrigger()|.
struct MOJO_LEGACY_ALIGNAS(8) MojoRemoveTriggerOptions {
  // The size of this structure, used for versioning.
  uint32_t struct_size;
...
MOJO_LEGACY_STATIC_ASSERT(sizeof(struct MojoRemoveTriggerOptions) == 8,
...
#ifdef __cplusplus
inline constexpr MojoArmTrapFlags MOJO_LEGACY_ARM_TRAP_FLAG_NONE = 0;
#else
#define MOJO_LEGACY_ARM_TRAP_FLAG_NONE ((MojoArmTrapFlags)0)
#endif

// Options passed to |MojoArmTrap()|.
struct MOJO_LEGACY_ALIGNAS(8) MojoArmTrapOptions {
  // The size of this structure, used for versioning.
  uint32_t struct_size;
...
MOJO_LEGACY_STATIC_ASSERT(sizeof(struct MojoArmTrapOptions) == 8,
...
// event will always convey the result |MOJO_LEGACY_RESULT_CANCELLED|.
//
// Parameters:
...
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| if the trap has been successfully created.
...
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| if the handle is now being observed by the trigger.
...
//   |MOJO_LEGACY_RESULT_ALREADY_EXISTS| if the trap already has a trigger
//   associated
...
// time for |context|, with the result |MOJO_LEGACY_RESULT_CANCELLED|.
//
...
//       Optional and only used when |MOJO_LEGACY_RESULT_FAILED_PRECONDITION| is
//       returned. See below.
...
//       |MOJO_LEGACY_RESULT_FAILED_PRECONDITION| is returned. See below.
//
// Returns:
//   |MOJO_LEGACY_RESULT_OK| if the trap has been successfully armed.
//       |num_blocking_events| and |blocking_events| are ignored.
//   |MOJO_LEGACY_RESULT_NOT_FOUND| if the trap does not have any triggers.
//       |num_blocking_events| and |blocking_events| are ignored.
//   |MOJO_LEGACY_RESULT_INVALID_ARGUMENT| if |trap_handle| is not a valid trap
//   handle,
//       or if |num_blocking_events| is non-null but |blocking_events| is
//       not.
//   |MOJO_LEGACY_RESULT_FAILED_PRECONDITION| if one or more triggers would have
...
#endif  // CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_C_SYSTEM_TRAP_H_

...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kBocaMaterialTypeUiIndicator);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kFjordOobeImageSwitch);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kOemAppsMustUpdateFromWebstore);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCrostiniArcSideload);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kCryptohomeDistributedModel);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCryptohomeUserDataAuth);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kHappinessTrackingSystem);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kHappinessTrackingOffice);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kHappinessTrackingSystemSlowAndLaggyDeepDive);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kNewFilesPolicyUX);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSkyVaultV2);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSkyVaultV3);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSmartDim);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kTPMFirmwareUpdate);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsFjordOobeImageSwitchEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsOemAppsMustUpdateFromWebstoreEnabled();

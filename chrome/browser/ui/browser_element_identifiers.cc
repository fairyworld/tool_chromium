...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kAutofillPaymentIconElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kMultistepFilterPageActionIconElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kBrowserFrameElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kContextualTasksWebUIPinButtonElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kContextualTasksWebUIOverflowMenuElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kFileSystemPageActionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kInfoBarContainerElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kIntentChipElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kIntentPickerPageActionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kAiOverlayDialogWebViewElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kReadAnythingSettingsButtonElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kReadAnythingViewModeElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kReadAnythingPageActionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kSystemMenuNewTabElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kSystemMenuRestoreItemElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kSystemMenuRestoreTabElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kTabGroupEditorBubbleButtonElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kTabGroupHeaderAttentionIndicatorElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kToolbarBatterySaverBubbleElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kDownloadBubbleRowElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kDownloadBubbleOpenButtonId);
DEFINE_CUSTOM_ELEMENT_EVENT_TYPE(kDownloadEndedCustomEventId);
DEFINE_CUSTOM_ELEMENT_EVENT_TYPE(kDownloadedFileOpenedCustomEventId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kToolbarSplitTabsMenuElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kTranslatePageActionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kWebAuthnAmbientSigninIconElementId);
...
DEFINE_CUSTOM_ELEMENT_EVENT_TYPE(kExtensionsMenuPinExtensionsEventId);
DEFINE_CUSTOM_ELEMENT_EVENT_TYPE(kExtensionsSidePanelPinExtensionsEventId);

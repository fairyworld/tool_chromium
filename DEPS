...
vars = {
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'quiche_revision': '089ae0f1c0726c4af91ef0010727235350a21862',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'edb60993da28bdb3e5bf347da9035a4c5f447983',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'b39264f2e4a112862aa4047018504726a0dbee11',
      'condition': 'checkout_src_internal',
  },

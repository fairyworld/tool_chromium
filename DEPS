...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7018122bf83f3e580bd71596ac1f5a95558bc165',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5997c4d0a1ac08ec73666b9678c18dba8f44097e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/snappy/src':
    Var('chromium_git') + '/external/github.com/google/snappy.git' + '@' + '27ab5f7f518430a021239bc26a5b2fd64affbc7b',

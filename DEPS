...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'bd7d20b4aa310907991d8d5de66f16c4cb990442',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b0709d4d6d9bfff786c9449f62b29cfcad4b3891',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '53b025e8bd6c04367560f723b26e20535f021736',
  # Three lines of non-changing comments so that
    ...
    'packages': [
      {
        ...
        'version': 'fXCRfhBYwC4utsEMzd88i6JmLfFUgp0yafYBLsUpwS4C',
      },
    ],
    'condition': 'non_git_source',
    'dep_type': 'cipd',
